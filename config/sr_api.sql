CREATE TABLE IF NOT EXISTS `api_db`.`categories` (
...
INSERT INTO `api_db`.`categories` (`id`, `name`, `description`, `created`, `modified`) VALUES
...
CREATE TABLE IF NOT EXISTS `api_db`.`products` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `api_db`.`products` (`id`, `name`, `description`, `price`, `category_id`, `created`, `modified`) VALUES
